...
TurfAPI.prototype.getTakeOverFeeds = function(callback, afterDate) {
  var query = this._afterDate2QueryString(afterDate);
  return this._get('/feeds/takeover' + query, callback);
};

TurfAPI.prototype.getMedalFeeds = function(callback, afterDate) {
  var query = this._afterDate2QueryString(afterDate);
  return this._get('/feeds/medal' + query, callback);
};

TurfAPI.prototype.getChatFeeds = function(callback, afterDate) {
  var query = this._afterDate2QueryString(afterDate);
  return this._get('/feeds/chat' + query, callback);
};

TurfAPI.prototype.getZoneFeeds = function(callback, afterDate) {
  var query = this._afterDate2QueryString(afterDate);
  return this._get('/feeds/zone' + query, callback);
};
