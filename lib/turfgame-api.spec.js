...
describe('TurfAPI', function() {
  ...
  describe('findUsers', function() {
    xit('should post to /users', function() {
    });

    xit('should handle an error response from /users', function() {
    });
  });
  ...
  describe('findTopUsers', function() {
    xit('should post to /users/top', function() {
    });

    xit('should handle error response from /users/top', function() {
    });
  });
  ...
  describe('findZones', function() {
    xit('should post to /zones', function() {
    });

    xit('should handle error response from /zones', function() {
    });
  });
